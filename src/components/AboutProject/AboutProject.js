  ...
  return (
    <section id='project' className="about-project">
      ...
      <ul className="about-project__descr-wrap">
        ...
        <li className="about-project__descr about-project__descr_second">Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</li>
